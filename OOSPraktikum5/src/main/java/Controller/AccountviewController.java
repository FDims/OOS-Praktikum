...
public class AccountviewController implements Initializable {
    final ObservableList<Transaction> transactionsList = FXCollections.observableArrayList();
            ...
            dialog.setResultConverter(buttonType ->  {
                if (buttonType == okButton) {
                            ...
                            Objects.equals(outgoingInterest_recipientText.getText(), ""))
                    {
                        ...
                        } catch (AccountDoesNotExistException | TransactionAttributeException | OutgoingException |
                                 IncomingException e) {
                            System.out.println(e.getMessage());
                        } catch (IOException e) {
                            e.printStackTrace();
                    ...
                    if (buttonType == okButton) {
                                ...
                                Objects.equals(outgoingInterest_recipientText.getText(), ""))
                        {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                            } catch (TransactionAttributeException | OutgoingException | IncomingException e) {
                                System.out.println(e);
                            }
                            updateListView(bank.getTransactions(name));
                            accountName.setText("Account: "+name);
    ...
    public void setupData(PrivateBank privateBank, String name) {
        ...
        deleteTransaction.setOnAction(event -> {
            ...
            if (result.isPresent() && result.get() == ButtonType.OK) {
                ...
                } catch (TransactionDoesNotExistException | IOException | AccountDoesNotExistException |
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        backButton.setOnMouseClicked(mouseEvent -> {
            try {
                root = FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("Main-view.fxml")));
            } catch (IOException e) {
                e.printStackTrace();
            }

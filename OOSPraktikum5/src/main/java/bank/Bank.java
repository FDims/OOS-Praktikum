...
public interface Bank {
     ...
     */
    boolean containsTransaction(String account, Transaction transaction) throws IncomingException, OutgoingException;
    ...
    /**
     * delete whole account in the bank
     *
     * @param account
    ...
    /**
     * return a list of all account in the bank
     *
     * @return
     */
